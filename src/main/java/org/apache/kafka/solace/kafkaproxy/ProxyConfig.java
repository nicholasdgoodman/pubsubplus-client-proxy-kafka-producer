...
public class ProxyConfig  extends AbstractConfig {
    ...
    public static final String DESTINATION_TYPE_CONFIG = "destination.type";
    public static final String DESTINATION_INCLUDE_PARTITION_CONFIG = "destination.include.partition";
    public static final String PARTITIONS_PER_TOPIC_CONFIG = "partitions.per.topic";
    ...
    static {
        CONFIG = new ConfigDef().define(LISTENERS_CONFIG, Type.LIST, Collections.emptyList(), new ConfigDef.NonNullValidator(), Importance.HIGH, LISTENERS_DOC)
                                ...
                                .define(DESTINATION_TYPE_CONFIG, Type.STRING, "topic", new ConfigDef.NonNullValidator(), Importance.MEDIUM, "")
                                .define(DESTINATION_INCLUDE_PARTITION_CONFIG, Type.BOOLEAN, false, new ConfigDef.NonNullValidator(), Importance.MEDIUM, "")
                                .define(PARTITIONS_PER_TOPIC_CONFIG, Type.INT, 1, Importance.MEDIUM, "")
                                .define(JCSMPProperties.HOST, Type.STRING, "localhost", Importance.HIGH, "")
                                .define(JCSMPProperties.VPN_NAME, Type.STRING, "default", Importance.HIGH, "")
